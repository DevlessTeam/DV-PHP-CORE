...
trait actions
{
    ...
    /**
     * Creates a one to many relationship between two tables. Eg -> afterQuerying()->createRelationship('categories', 'products', 'id', 'category_id')
     *. In the example above categories within the system will be outputted with each one containing the list of related products.
     *
