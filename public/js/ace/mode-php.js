ace.define("ace/mode/php", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/php_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/unicode"], function(e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        a = function() {
            var e = s,
                n = i.arrayToMap("firstly|secondly|thirdly|beSureTo|lastly|next|then|also|convertToUpperCase|otherwise|elseWhenever|whenever|onQuery|onUpdate|onCreate|onDelete|beforeQuerying|beforeCreating|beforeUpdating|beforeDeleting|afterQuerying|afterCreating|afterUpdating|afterDeleting|onAnyRequest|$EVENT".split("|")),
                // r = i.arrayToMap("die|echo|empty|exit|eval|include|include_once|isset|list|require|require_once|return|print|unset".split("|")),
                o = i.arrayToMap("evaluate|getCharacter|getThirdCharacter|getSecondCharacter|getFirstCharacter|concatenate|mutateResponsePayload|mutateResponseMessage|mutateStatusCode|percentOf|roundUp|getSquareRoot|findSquareRootOf|divideBy|divide|multiply|subtract|sumUp|calculate|getResponsePayload|getResponseMessage|getStatusCode|getResponse|generateUniqueId|generateRandomString|generateRandomAlphanums|generateRandomInteger|getTimestamp|getCurrentYear|getCurrentMonth|getCurrentDay|getCurrentHour|getFormattedDate|getCurrentSecond|getCurrentMinute|removeElementFromCollection|addAnElementToCollection|paginateCollection|reduceNumberOfElementsTo|offsetCollectionBy|sortCollectionBy|reverseTheCollection|countElementsInCollection|forEachOneIn|onTheCollectionApplyMethod|fetchOnly|fetchAllWith|countTheNumberOfElements|getLastElement|getElement|getFirstElement|getAllKeys|getValuesWithoutKeys|collect|fromTheCollectionOf|run|authenticateUser|denyExternalAccess|allowExternalAccess|grantOnlyAdminAccess|onTable|succeedWith|failWith|makeExternalRequest|getResults|storeAs|assign|usingService|callMethod|withParams|withoutParams|to|from|assignValues|stopAndOutput|help|set|read".split("|")),
