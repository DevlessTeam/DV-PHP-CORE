$(document).ready(function() {
        ...
        // Add new user
        $('#save').click(function() {
            var id = (Datatable.data()[0] !== undefined) ? parseInt(Datatable.data()[0][1]) + 1 : 1;
            ...
            if(payload.password === payload.confirm_password) {
                $.ajax({
                    ...
                    if(res) {
                        ...
                        Datatable.row(element_id).data(["", user_id,  payload.username, payload.first_name, payload.last_name, payload.phone_number, payload.email, active]);
                        $('.alert').show();
                    } else {
