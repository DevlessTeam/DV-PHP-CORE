...
/** 
* To use the PHP Class. 
* First  import it into the rules of the service you want to use it
* Then call on the execute method 
* Eg 
* ->import("PHPClass")
* ->execute("sampleClass", "hello", [])
**/
...
';     
    ...
    { 
        ds::service($this->serviceName, 'class')->addData([["script"=> '
/** 
* To use the PHP Class. 
* First  import it into the rules of the service you want to use it
* Then call on the execute method 
