...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-car fa-fw"></i> New Farmer
                                </div>
                            </a>
                        </li>
                    </ul>
            ...
            if(res.status_code === 637){ window.location = '/service/TTLUSSD/view/index'; }
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu href="<?= DvNavigate($payload, "farmers"); ?>"><i class="fa fa-user"></i> Farmers</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Farmers <small>All farmers under TTL.</small>
                            <button class="btn btn-danger pull-right" style="background: #ff5722" data-toggle="modal" data-target="#addFarmer">Add Farmer</button>
                        </h1>
                    </div>
                </div> 
                ...
                <div class="col-md-12">
                    <!-- Add farmers modal -->
                    <div class="modal fade-scale" tabindex="-1" role="dialog" id="addFarmer">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="background-color: whitesmoke;">
                            <div class="modal-header" style="background: #388e3c;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" style="color: white;">Add Farmer</h4>
                            </div>
                            <div class="modal-body">
                               <form class="form-horizontal" id="farmer-form" method="post" action="#">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Adam Muhideen" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="phone" class="col-sm-2 control-label">Phone</label>
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="phone" id="phone" placeholder="0266783477" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="location" class="col-sm-2 control-label">Location</label>
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="location" id="location" placeholder="East Legon" required>
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label for="farmer" class="col-sm-2 control-label">FBO</label>
                                        <div class="col-sm-10">
                                            <input type="hidden" id="no_of_farmers">
                                            <select class="form-control" name="TTLUSSD_fbo_id" id="farmer">
                                                <option disabled selected value>-- select FBO --</option>
                                            </select>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="acres" class="col-sm-2 control-label">No. of Acres</label>
                                        <div class="col-sm-10">
                                        <input type="number" class="form-control" name="acres" id="acres" placeholder="20" min="1" required>
                                        </div>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="farmers-table" width="100%">
    ...
    <!-- Custom JS -->
    <script src="<?= DvAssetPath($payload, "js/farmers.js"); ?>"></script>
     <!-- DATA TABLE SCRIPTS -->
