...
<head>
    ...
    <title>TTL Admin - Tractor Owners</title>
	<!-- Bootstrap Styles-->
...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu href="<?= DvNavigate($payload, "owners"); ?>"><i class="fa fa-group"></i> Tractor Owners</a>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Tractor Owners <small>All tractor owners under TTL.</small>
                            <button class="btn btn-danger pull-right" style="background: #ff5722" data-toggle="modal" data-target="#addOwner">Add Owner</button>
                        </h1>
                    </div>
                </div> 
                ...
                <div class="col-md-12">
                    <!-- Add farmers modal -->
                    <div class="modal fade-scale" tabindex="-1" role="dialog" id="addOwner">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="background-color: whitesmoke;">
                            <div class="modal-header" style="background: #388e3c;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" style="color: white;">Add Owner</h4>
                            </div>
                            <div class="modal-body">
                               <form class="form-horizontal" id="farmer-form" method="post" action="#">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type="text" class="form-control" name="type" id="type" placeholder="Mahindra">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="acres" class="col-sm-2 control-label">No. of Tractors</label>
                                        <div class="col-sm-10">
                                        <input type="number" class="form-control" name="no_of_tractors" id="no_of_tractors" placeholder="20" min="0">
                                        </div>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="owners-table" width="100%">
    ...
    <!-- Custom JS -->
    <script src="<?= DvAssetPath($payload, "js/owners.js"); ?>"></script>
     <!-- DATA TABLE SCRIPTS -->
