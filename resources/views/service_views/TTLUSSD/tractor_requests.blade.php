...
<head>
    ...
    <title>TTL Admin - Tractor Requests</title>
    <!-- Bootstrap Styles-->
...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu "href="<?= DvNavigate($payload, "tractor_requests"); ?>"><i class="fa fa-truck"></i> Tractor Requests</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Tractor Request <small>Requests from farmers via USSD</small>
                        </h1>
                    </div>
                </div>
                 <!-- /. ROW  -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Tractor Requests modal -->
                    <div class="modal fade-scale" tabindex="-1" role="dialog" id="tractorRequest">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="background-color: whitesmoke;">
                            <div class="modal-header" style="background: #388e3c;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" style="color: white;">Tractor Request</h4>
                            </div>
                            <div class="modal-body">
                               <form class="form-horizontal" id="farmer-form" method="post" action="#">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="acres" id="acres" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="acres" class="col-sm-2 control-label">Status</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="status" id="status">
                                            </select>
                                            <input type="hidden" name="tractor_id" id="tractor_id">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn btn-danger" id="complete_request">Complete</button>
                                        <button class="btn btn-success" id="assign_request">Assign</button>
                                    </div>
                                </form>
                            </div>
                            </div><!-- /.modal-content -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tractor-requests" width="100%"></table>
                            </div>
    ...
    <!-- Custom JS -->
    <script src="<?= DvAssetPath($payload, "js/tractor-requests.js"); ?>"></script>
     <!-- DATA TABLE SCRIPTS -->
