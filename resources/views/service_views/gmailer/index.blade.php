...
<html lang="en">
  ...
  <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 fir-item">
                            ...
                            <form class="dv-add-oneto:gmailer:settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sender_email" class="form-control" placeholder="Enter you gmail address" autocomplete="off" /> 
                                </div>
                                <div class="form-group">
                                    <label for="api_secret">Gmail Password</label>
                                    <input type="password" name="sender_password" class="form-control " placeholder="please provide your gmail password" autocomplete="off" />   
                                </div>
                        ...
                        <div class = "col-md-6 sec-item hide">
                            <table class="table table-striped" id="user-credentials">
                              ...
                              <tbody class="dv-param:size:1:get-all:gmailer:settings">
                                <tr>
                            ...
                            <form class="dv-update-oneof:gmailer:settings">
                        ...
                        <div class="col-md-6 docs">
                            <h3 class="changePostion step-two">Gmailer Docs</h3>
                            <p>Gmailer allows you to send out emails within DevLess using your gmail account.
                            <h3 class="">Getting Started With Gmailer</h3> 
                            <p>
                                Getting started with cloudinary platform is as easy as anything you can think of. 
                                <ul>
                                    <li>First and foremost, you will need a <a href="https://gmail.com" target="blank">Gmail Account</a></li>
                                    <li>Next you will have to allow DevLess to use your <a href="https://myaccount.google.com/u/0/lesssecureapps" target="blank">Gmail Account to send out emails</a></li>
                            ...
                            send($subject, $message, $recipient_email) <br>    
                            ...
                            Example of using it in the Service Rules<br>
                                <span class="methods code">
                                    ->run('gmailer', 'send', ['My Subject', '<b>Message Body</b>', 'edmond@devless.io', 'team@devless.io'])
    ...
    <script type="text/javascript">
        ...
        SDK.queryData("gmailer","settings",{},function(resp){
