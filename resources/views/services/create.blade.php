                    ...
                    <form action="{{ route('services.store') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <input class="form-control" name="name" id="name" type="text" placeholder="Service Name" value="">                                @if($errors->has("name"))
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <textarea class="form-control" name="description" id="description" value=""> Description</textarea>                                @if($errors->has("description"))
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <div class="alert alert-warning bs-alert-old-docs">
                                    <strong>Heads up!</strong> Only fill out below if you need to connect the service to
                                    a remote database. Otherwise leave as is.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <select id="db-type" name="driver" class="form-control m-b-10">
                                    ...
                                    @endforeach
                                </select> @if($errors->has("driver"))
                                <span class="help-block">{{ $errors->first("driver") }}</span> @endif
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 col-sm-2 control-label" for="g-txt">Database Name</label>
                            <div class="col-lg-10 col-sm-10">
                                <input class="form-control" name="database" id="database" type="text" placeholder="Database Name" value="">                                @if($errors->has("database"))
                                <span class="help-block">{{ $errors->first("database") }}</span> @endif
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 col-sm-2 control-label" for="g-txt">Host Name</label>
                            <div class=" col-lg-10 col-sm-10">
                                <input class="form-control" name="hostname" id="hostname" placeholder="" type="text" placeholder="127.0.0.1" value="">                                @if($errors->has("hostname"))
                                <span class="help-block">{{ $errors->first("hostname") }}</span> @endif
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 col-sm-2 control-label" for="g-txt">Username</label>
                            <div class=" col-lg-10 col-sm-10">
                                <input class="form-control" name="username" id="username" placeholder="" type="text" placeholder="root" value="">                                @if($errors->has("username"))
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <input class="form-control" id="password" name="password" placeholder="password" value="" type="password">                                @if($errors->has("password"))
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-lg-10 col-sm-10">
                                <input class="form-control" id="port" name="port" placeholder="Port" value="" type="number">                                @if($errors->has("port"))
                                <span class="help-block">{{ $errors->first("port") }}</span> @endif
                            </div>
                        </div>
                        <div class="form-group">
