...
<div class="page-head">
    ...
    <div class="pull-right" style="position: relative; bottom: 23px;">
        <button type="button" id="addbtn" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
            <i class="fa fa-plus"></i> Add User</button>
        <button type="button" id="settingsbtn" class="btn btn-info" data-toggle="modal" data-target="#settings">
            <i class="fa fa-cog"></i> Settings</button>
        <button type="button" class="btn btn-danger" id="delete-users">
            <i class="fa fa-ban"></i> Delete User(s)</button>
    </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="users-table" width="100%">
            ...
            <tbody>
                ...
                <tr id="dtRow">
                    ...
                    <td>{{$user->email}}</td>
                    <td>
                        @if($user->status == 1) true @else false @endif
                    </td>
                </tr>
                @endforeach
            </tbody>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="add_first_name" placeholder="First Name">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="add_last_name" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="add_phone_number" placeholder="+233245678192">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="add_confirm_password" placeholder="Confirm Password">
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#" class="form-horizontal">
                            <div class="form-group">
                                <label for="session" class="col-sm-5 control-label">
                                    <b>Hours till User is logged out</b>
                                </label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label for="Expiration" class="col-sm-5 control-label">
                                    <b>Keep User logged in forever </b>
                                </label>
                                <div class="col-sm-7">
                                    <div class="checkbox ">
                                        <label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-5 control-label" for="selfSignUp">
                                    <b>Allow Users to signup automatically</b>
                                </label>
                                <div class="col-sm-7">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" id="self_signup_true" name="s_signup">Yes</label>
                                        <label>
                                            <input type="radio" checked id="self_signup_false" name="s_signup">No</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-5 control-label">
                                    <b>Verify New Users via Email</b>
                                </label>
                                <div class="col-sm-7">
                                    <div class="radio">
                                        <label for="v_enable">
                                            <input type="radio" name="v_account" id="verify_email_true">Yes</label>
                                        <label for="v_disable">
                                            <input type="radio" checked id="verify_email_false" name="v_account">No</label>
                                    </div>
                                </div>
                            </div>
                        </form>
